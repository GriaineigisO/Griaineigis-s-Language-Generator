...
import {derivedOrInheritedTransVerb, etymologyArrayTransVerb, etymologyTransVerb, transitiveVerb3SArray, transitiveVerbPastArray} from '/englishWordArrays/Verbs/englishTransitiveVerbs.js';
...
function selectDerivationalAffixes() {
    let chosenDerivations = [VtoADJprone, NtoNPossessorOf, NADJtoADJpossessorOfQuality, bodyParts, ADJtoCausVerb];
        ...
        if(Math.floor(Math.random() * 3) === 1) {
            ...
            if(transitiveVerbArray[i] === "accept") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyADJ[adjectiveArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(proneAffix + "A"))}</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"`;
                        } else {
                                etymologyADJ[adjectiveArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + proneAffix))}-</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[transitiveVerbArray.indexOf(transitiveVerbArray[i])])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"`;
                };
                } else {
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspaccepting")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
                                etymologyADJ.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(proneAffix + "A"))}</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"`)
                        } else {
                ...
                if(exampleCounter < 6) {
                        ...
                        exampleLi.innerHTML = `<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[i])))}</i> "to&nbsp${removeVFromVerb(transitiveVerbArray[i])}" > <i>${spell(addGrammaticalAffixes(derivedTerm))}</i> "${meaning}"`;
                        ul.appendChild(exampleLi)
                };
                exampleCounter++; 
            };
            if(transitiveVerbArray[i] === "arrange") {
                let meaning = "methodical";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspmethodical")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "blame") {
                let meaning = "accusatory";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspaccusatory")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "blowV") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("windier")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "choose") {
                let meaning = "selective";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspselective")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "compel") {
                let meaning = "compelling";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspcompelling")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "fight") {
                let meaning = "aggressive";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspaggressive")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "follow") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsployal")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "forget") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspforgetful")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "give") {
                let meaning = "generous";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspgenerous")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "hunt") {
                let meaning = "predatory";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsppredatory")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "instruct") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspinstructive")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "insult") {
                let meaning = randomIndexOfArray(["mean", "rude", "offensive", "unkind", "nasty"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "mean") {
                                comparativeAdjectiveArray.push("meaner")
                        }
                        if(meaning === "rude") {
                                comparativeAdjectiveArray.push("ruder")
                        }
                        if(meaning === "offensive") {
                                comparativeAdjectiveArray.push("more&nbspoffensive")
                        }
                        if(meaning === "unkind") {
                                comparativeAdjectiveArray.push("more&nbspunkind")
                        }
                        if(meaning === "nasty") {
                                comparativeAdjectiveArray.push("nastier")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "know") {
                let meaning = randomIndexOfArray(["wise", "smart", "intelligent", "clever"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "wise") {
                                comparativeAdjectiveArray.push("wiser")
                        }
                        if(meaning === "smart") {
                                comparativeAdjectiveArray.push("smarter")
                        }
                        if(meaning === "intelligent") {
                                comparativeAdjectiveArray.push("more&nbspintelligent")
                        }
                        if(meaning === "clever") {
                                comparativeAdjectiveArray.push("clever")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "lack") {
                let meaning = randomIndexOfArray(["empty", "insufficient", "devoid", "bereft", "lacking"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "insufficient") {
                                comparativeAdjectiveArray.push("more&nbspinsufficient")
                        }
                        if(meaning === "devoid") {
                                comparativeAdjectiveArray.push("more&nbspdevoid")
                        }
                        if(meaning === "bereft") {
                                comparativeAdjectiveArray.push("more&nbspbereft")
                        }
                        if(meaning === "lacking") {
                                comparativeAdjectiveArray.push("more&nbsplacking")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "learn") {
                let meaning = randomIndexOfArray(["studious", "erudite", "smart", "knowledgeable", "well-versed"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "studious") {
                                comparativeAdjectiveArray.push("more&nbspstudious")
                        }
                        if(meaning === "erudite") {
                                comparativeAdjectiveArray.push("more&nbsperudite")
                        }
                        if(meaning === "smart") {
                                comparativeAdjectiveArray.push("smarter")
                        }
                        if(meaning === "knowledgeable") {
                                comparativeAdjectiveArray.push("more&nbsknowledgeable")
                        }
                        if(meaning === "well-versed") {
                                comparativeAdjectiveArray.push("more&nbspwell-versed")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "leave") {
                let meaning = randomIndexOfArray(["absent", "gone", "away"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "absent") {
                                comparativeAdjectiveArray.push("more&nbspabsent")
                        }
                        if(meaning === "gone") {
            ...
            if(transitiveVerbArray[i] === "loveV") {
                let meaning = randomIndexOfArray(["loving", "affectionate", "caring", "doting"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "loving") {
                                comparativeAdjectiveArray.push("more&nbsploving")
                        }
                        if(meaning === "affectionate") {
                                comparativeAdjectiveArray.push("more&nbspaffectionate")
                        }
                        if(meaning === "caring") {
                                comparativeAdjectiveArray.push("more&nbspcaring")
                        }
                        if(meaning === "doting") {
                                comparativeAdjectiveArray.push("more&nbspdoting")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "make") {
                let meaning = randomIndexOfArray(["creative", "industrious"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "creative") {
                                comparativeAdjectiveArray.push("more&nbspcreative")
                        }
                        if(meaning === "industrious") {
                                comparativeAdjectiveArray.push("more&nbspindustrious")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "marry") {
                let meaning = randomIndexOfArray(["wed", "betrothed"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "wed") {
                                comparativeAdjectiveArray.push("more&nbspwed")
                        }
                        if(meaning === "betrothed") {
                                comparativeAdjectiveArray.push("more&nbspbetrothed")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "need") {
                let meaning = "in&nbspneed"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspin&nbspneedd")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "praise") {
                let meaning = randomIndexOfArray(["exalting", "complementive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "exalting") {
                                comparativeAdjectiveArray.push("more&nbspexalting")
                        }
                        if(meaning === "complementive") {
                                comparativeAdjectiveArray.push("more&nbspcomplementive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "perceive") {
                let meaning = randomIndexOfArray(["perceptive", "alert", "watchful"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "perceptive") {
                                comparativeAdjectiveArray.push("more&nbspperceptive")
                        }
                        if(meaning === "alert") {
                                comparativeAdjectiveArray.push("more&nbspalert")
                        }
                        if(meaning === "watchful") {
                                comparativeAdjectiveArray.push("more&nbspwatchful")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "persuade") {
                let meaning = "persuasive"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsppersuasive")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "please") {
                let meaning = randomIndexOfArray(["pleasing", "delightful", "likeable", "pleasant"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "pleasing") {
                                comparativeAdjectiveArray.push("more&nbsppleasing")
                        }
                        if(meaning === "delightful") {
                                comparativeAdjectiveArray.push("more&nbspdelightful")
                        }
                        if(meaning === "likeable") {
                                comparativeAdjectiveArray.push("more&nbsplikeable")
                        }
                        if(meaning === "pleasant") {
                                comparativeAdjectiveArray.push("more&nbsppleasant")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "prefer") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspbiased")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "protect"||transitiveVerbArray[i] === "defend") {
                let meaning = randomIndexOfArray(["protective", "defensive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "protective") {
                                comparativeAdjectiveArray.push("more&nbspprotective")
                        }
                        if(meaning === "defensive") {
                                comparativeAdjectiveArray.push("more&nbspdefensive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "pull") {
                let meaning = randomIndexOfArray(["addictive", "entrapping", "influential", "interesting", "fascinating"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "addictive") {
                                comparativeAdjectiveArray.push("more&nbspaddictive")
                        }
                        if(meaning === "defensive") {
                                comparativeAdjectiveArray.push("more&nbspentrapping")
                        }
                        if(meaning === "influential") {
                                comparativeAdjectiveArray.push("more&nbspinfluential")
                        }
                        if(meaning === "interesting") {
                                comparativeAdjectiveArray.push("more&nbspinteresting")
                        }
                        if(meaning === "fascinating") {
                                comparativeAdjectiveArray.push("more&nbspfascinating")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "push") {
                let meaning = randomIndexOfArray(["impelling", "booming", "dynamic", "impulsive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "impelling") {
                                comparativeAdjectiveArray.push("more&nbspimpelling")
                        }
                        if(meaning === "booming") {
                                comparativeAdjectiveArray.push("more&nbspbooming")
                        }
                        if(meaning === "dynamic") {
                                comparativeAdjectiveArray.push("more&nbspdynamic")
                        }
                        if(meaning === "impulsive") {
                                comparativeAdjectiveArray.push("more&nbspimpulsive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "put") {
                let meaning = randomIndexOfArray(["in&nbspcharge", "authorative"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "in&nbspcharge") {
                                comparativeAdjectiveArray.push("more&nbspin&nbspcharge")
                        }
                        if(meaning === "authorative") {
                                comparativeAdjectiveArray.push("more&nbspauthorative")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "read") {
                let meaning = randomIndexOfArray(["literate", "studious", "erudite"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "literate") {
                                comparativeAdjectiveArray.push("more&nbspliterate")
                        }
                        if(meaning === "studious") {
                                comparativeAdjectiveArray.push("more&nbspstudious")
                        }
            ...
            if(transitiveVerbArray[i] === "refresh") {
                let meaning = randomIndexOfArray(["refreshing", "invigorating"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "refreshing") {
                                comparativeAdjectiveArray.push("more&nbsprefreshing")
                        }
                        if(meaning === "invigorating") {
                                comparativeAdjectiveArray.push("more&nbspinvigorating")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "remember") {
                let meaning = randomIndexOfArray(["having&nbspa&nbspgood&nbspmemory", "reminiscing", "recollective", "pensive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "reminiscing") {
                                comparativeAdjectiveArray.push("more&nbspreminiscing")
                        }
                        if(meaning === "recollective") {
                                comparativeAdjectiveArray.push("more&nbsprecollective")
                        }
                        if(meaning === "recollepensivective") {
                                comparativeAdjectiveArray.push("more&nbsppensive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "respect") {
                let meaning = randomIndexOfArray(["respectful", "polite", "well-mannered"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "respectful") {
                                comparativeAdjectiveArray.push("more&nbsprespectful")
                        }
                        if(meaning === "polite") {
                                comparativeAdjectiveArray.push("more&nbsppolite")
                        }
                        if(meaning === "well-mannered") {
                                comparativeAdjectiveArray.push("more&nbspwell-mannered")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "revel") {
                let meaning = randomIndexOfArray(["jovial", "entertained", "happy", "cheerful", "playful", "rowdy", "jolly"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "jovial") {
                                comparativeAdjectiveArray.push("more&nbspjovial")
                        }
                        if(meaning === "entertained") {
                                comparativeAdjectiveArray.push("more&nbspentertained")
                        }
                        if(meaning === "happy") {
                                comparativeAdjectiveArray.push("happier")
                        }
                        if(meaning === "cheerful") {
                                comparativeAdjectiveArray.push("more&nbspcheerful")
                        }
                        if(meaning === "playful") {
                                comparativeAdjectiveArray.push("more&nbspplayful")
                        }
                        if(meaning === "rowdy") {
                                comparativeAdjectiveArray.push("rowdier")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "reward") {
                let meaning = randomIndexOfArray(["rewarding", "worthwhile"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "rewarding") {
                                comparativeAdjectiveArray.push("more&nbsprewarding")
                        }
                        if(meaning === "worthwhile") {
                                comparativeAdjectiveArray.push("more&nbspworthwhile")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "roast") {
                let meaning = randomIndexOfArray(["hot", "piping-hot", "scalding"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "piping-hot") {
                                comparativeAdjectiveArray.push("more&nbsppiping-hot")
                        }
                        if(meaning === "scalding") {
                                comparativeAdjectiveArray.push("more&nbspscalding")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "run") {
                let meaning = randomIndexOfArray(["fast", "quick", "swift"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "quick") {
                                comparativeAdjectiveArray.push("quicker")
                        }
                        if(meaning === "swift") {
                                comparativeAdjectiveArray.push("swifter")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "say") {
                let meaning = randomIndexOfArray(["vocal", "loud", "long-winded"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "vocal") {
                                comparativeAdjectiveArray.push("more&nbspvocal")
                        }
                        if(meaning === "loud") {
                                comparativeAdjectiveArray.push("louder")
                        }
                        if(meaning === "long-winded") {
                                comparativeAdjectiveArray.push("more&nbsplong-winded")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "see") {
                let meaning = randomIndexOfArray(["watchful", "observant"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "observant") {
                                comparativeAdjectiveArray.push("more&nbspobservant")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "scratch") {
                let meaning = randomIndexOfArray(["sharp", "rough", "abrasive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "abrasive") {
                                comparativeAdjectiveArray.push("more&nbspabrasive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "sell") {
                let meaning = "merchantile";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspmerchantile")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "separate") {
                let meaning = randomIndexOfArray(["divisive", "intrusive", "interruptive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "divisive") {
                                comparativeAdjectiveArray.push("more&nbspdivisive")
                        }
                        if(meaning === "intrusive") {
                                comparativeAdjectiveArray.push("more&nbspintrusive")
                        }
                        if(meaning === "interruptive") {
                                comparativeAdjectiveArray.push("more&nbspinterruptive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "shame") {
                let meaning = randomIndexOfArray(["shameful", "disgraceful", "pathetic", "degenerate"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "shameful") {
                                comparativeAdjectiveArray.push("more&nbspshameful")
                        }
                        if(meaning === "disgraceful") {
                                comparativeAdjectiveArray.push("more&nbspdisgraceful")
                        }
                        if(meaning === "pathetic") {
                                comparativeAdjectiveArray.push("more&nbsppathetic")
                        }
                        if(meaning === "degenerate") {
                                comparativeAdjectiveArray.push("more&nbspdegenerate")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "show") {
                let meaning = randomIndexOfArray(["explanatory", "instructive", "helpful"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "explanatory") {
                                comparativeAdjectiveArray.push("more&nbspexplanatory")
                        }
                        if(meaning === "instructive") {
                                comparativeAdjectiveArray.push("more&nbspinstructive")
                        }
                        if(meaning === "helpful") {
                                comparativeAdjectiveArray.push("more&nbsphelpful")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "sing") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspmusical")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "smash") {
                let meaning = "angry";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
            ...
            if(transitiveVerbArray[i] === "split") {
                let meaning = randomIndexOfArray(["divisive", "polarising"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        if(meaning === "polarising") {
                                comparativeAdjectiveArray.push("more&nbsppolarising")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "sprout") {
                let meaning = randomIndexOfArray(["sprouting", "young"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "sprouting") {
                                comparativeAdjectiveArray.push("more&nbspsprouting")
                        }
                        if(meaning === "young") {
                                comparativeAdjectiveArray.push("more&nbspyoung")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "stab"||transitiveVerbArray[i] === "kill"||transitiveVerbArray[i] === "murder"||transitiveVerbArray[i] === "slaughter") {
                let meaning = randomIndexOfArray(["murderous", "piercing", "slaughterous", "homicidal", "blood-thirsty"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "murderous") {
                                comparativeAdjectiveArray.push("more&nbspmurderous")
                        }
                        if(meaning === "piercing") {
                                comparativeAdjectiveArray.push("more&nbsppiercing")
                        }
                        if(meaning === "slaughterous") {
                                comparativeAdjectiveArray.push("more&nbspslaughterous")
                        }
                        if(meaning === "homicidal") {
                                comparativeAdjectiveArray.push("more&nbsphomicidal")
                        }
                        if(meaning === "blood-thirsty") {
                                comparativeAdjectiveArray.push("more&nbspblood-thirsty")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "steal") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsptheftuous")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "stick") {
                let meaning = randomIndexOfArray(["sticky", "adherent"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "sticky") {
                                comparativeAdjectiveArray.push("stickier")
                        }
                        if(meaning === "adherent") {
                                comparativeAdjectiveArray.push("more&nbspadherent")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "strike") {
                let meaning = randomIndexOfArray(["aggressive", "threatening", "harmful", "dangerous"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "aggressive") {
                                comparativeAdjectiveArray.push("more&nbspaggressive")
                        }
                        if(meaning === "threatening") {
                                comparativeAdjectiveArray.push("more&nbspthreatening")
                        }
                        if(meaning === "harmful") {
                                comparativeAdjectiveArray.push("more&nbspharmful")
                        }
                        if(meaning === "dangerous") {
                                comparativeAdjectiveArray.push("more&nbspdangerous")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "support") {
                let meaning = "supportive";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspsupportive")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "surpass") {
                let meaning = randomIndexOfArray(["excellent", "incredible", "amazing", "superior"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "excellent") {
                                comparativeAdjectiveArray.push("more&nbspexcellent")
                        }
                        if(meaning === "incredible") {
                                comparativeAdjectiveArray.push("more&nbspincredible")
                        }
                        if(meaning === "amazing") {
                                comparativeAdjectiveArray.push("more&nbspamazing")
                        }
                        if(meaning === "superior") {
                                comparativeAdjectiveArray.push("more&nbspsuperior")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "take") {
                let meaning = randomIndexOfArray(["greedy", "interesting", "captivating", "receptive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "greedy") {
                                comparativeAdjectiveArray.push("greedier")
                        }
                        if(meaning === "interesting") {
                                comparativeAdjectiveArray.push("more&nbspinteresting")
                        }
                        if(meaning === "captivating") {
                                comparativeAdjectiveArray.push("more&nbspcaptivating")
                        }
                        if(meaning === "receptive") {
                                comparativeAdjectiveArray.push("more&nbspreceptive")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "teach") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspeducational")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "thank") {
                let meaning = randomIndexOfArray(["grateful", "thankful"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "grateful") {
                                comparativeAdjectiveArray.push("more&nbspgrateful")
                        }
                        if(meaning === "thankful") {
                                comparativeAdjectiveArray.push("more&nbspthankful")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "use") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspmanipulative")
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(transitiveVerbArray[i] === "want") {
                let meaning = randomIndexOfArray(["jealous", "covetous", "envious", "lacking"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "jealous") {
                                comparativeAdjectiveArray.push("more&nbspjealous")
                        }
                        if(meaning === "covetous") {
                                comparativeAdjectiveArray.push("more&nbspcovetous")
                        }
                        if(meaning === "envious") {
                                comparativeAdjectiveArray.push("more&nbspenvious")
                        }
                        if(meaning === "lacking") {
                                comparativeAdjectiveArray.push("more&nbsplacking")
                        }
            ...
            if(transitiveVerbArray[i] === "wash") {
                let meaning = randomIndexOfArray(["clean", "hygenic"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "clean") {
                                comparativeAdjectiveArray.push("cleaner")
                        }
                        if(meaning === "hygenic") {
                                comparativeAdjectiveArray.push("more&nbsphygenic")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "write") {
                let meaning = randomIndexOfArray(["earned", "educated"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "earned") {
                                comparativeAdjectiveArray.push("more&nbspearned")
                        }
                        if(meaning === "educated") {
                                comparativeAdjectiveArray.push("more&nbspeducated")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "invite") {
                let meaning = randomIndexOfArray(["inviting", "hospitable"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "inviting") {
                                comparativeAdjectiveArray.push("more&nbspinviting")
                        }
                        if(meaning === "hospitable") {
                                comparativeAdjectiveArray.push("more&nbsphospitable")
                        }
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(transitiveVerbArray[i]);
            ...
            if(transitiveVerbArray[i] === "leap") {
                let meaning = randomIndexOfArray(["bouncy", "energetic", "dynamic"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = transitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "bouncy") {
                                comparativeAdjectiveArray.push("bouncier")
                        }
                        if(meaning === "energetic") {
                                comparativeAdjectiveArray.push("more&nbspenergetic")
                        }
                        if(meaning === "dynamic") {
                                comparativeAdjectiveArray.push("more&nbspdynamic")
                        }
    ...
    for(let i = 0; i < intransitiveVerbArray.length; i++) {
        ...
        if(Math.floor(Math.random() * 3) === 1) {
            ...
            if(intransitiveVerbArray[i] === "aim") {
                let meaning = randomIndexOfArray(["precise", "accurate"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        if(suffixOrPrefix === "suffix") {
                                etymologyADJ[adjectiveArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(proneAffix + "A"))}</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"`;
                        } else {
                                etymologyADJ[adjectiveArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + proneAffix))}-</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[intransitiveVerbArray.indexOf(intransitiveVerbArray[i])])))}</i>&nbsp"to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}"`;
                };
                } else {
                        adjectiveArray.push(meaning);
                        if(meaning === "precise") {
                                comparativeAdjectiveArray.push("more&nbspprecise")
                        };
                        if(meaning === "accurate") {
                                comparativeAdjectiveArray.push("more&nbspaccurate")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
                                etymologyADJ.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(proneAffix + "A"))}</i>&nbsp"derives&nbspadjectives&nbspfrom&nbspverbs&nbspdescribing&nbspthe&nbspstate&nbspof&nbspthe&nbspagent&nbspof&nbspthe&nbspaction"`)
                        } else {
                ...
                if(exampleCounter < 6) {
                        let exampleLi = document.createElement("li");
                        exampleLi.innerHTML = `<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[i])))}</i> "to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}" > <i>${spell(addGrammaticalAffixes(derivedTerm))}</i> "${meaning}"`;
                        ul.appendChild(exampleLi)
                };
                exampleCounter++; 
            };
            if(intransitiveVerbArray[i] === "appear") {
                let meaning = randomIndexOfArray(["visible", "obvious", "apparent"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "apparent") {
                                comparativeAdjectiveArray.push("more&nbspapparent")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "ask") {
                let meaning = randomIndexOfArray(["curious", "inquisitive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "curious") {
                                comparativeAdjectiveArray.push("more&nbspcurious")
                        };
                        if(meaning === "inquisitive") {
                                comparativeAdjectiveArray.push("more&nbspinquisitive")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "babble") {
                let meaning = randomIndexOfArray(["illegible", "annoying", "nonsensical"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "illegible") {
                                comparativeAdjectiveArray.push("more&nbspillegible")
                        };
                        if(meaning === "annoying") {
                                comparativeAdjectiveArray.push("more&nbspannoying")
                        };
                        if(meaning === "nonsensical") {
                                comparativeAdjectiveArray.push("more&nbspnonsensical")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "bloom") {
                let meaning = randomIndexOfArray(["blooming", "blossoming", "lush"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "blooming") {
                                comparativeAdjectiveArray.push("more&nbspblooming")
                        };
                        if(meaning === "blossoming") {
                                comparativeAdjectiveArray.push("more&nbspblossoming")
                        };
                        if(meaning === "lush") {
                                comparativeAdjectiveArray.push("more&nbsplush")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "come") {
                let meaning = randomIndexOfArray(["coming", "near", "next",  "close&nbspby", "adjacent"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "close&nbspby") {
                                comparativeAdjectiveArray.push("closer&nbspby")
                        };
                        if(meaning === "adjacent") {
                                comparativeAdjectiveArray.push("more&nbspadjacent")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "complain") {
                let meaning = randomIndexOfArray(["annoyed", "irritated", "displeased"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "annoyed") {
                                comparativeAdjectiveArray.push("more&nbspannoyed")
                        };
                        if(meaning === "irritated") {
                                comparativeAdjectiveArray.push("more&nbspirritated")
                        };
                        if(meaning === "displeased") {
                                comparativeAdjectiveArray.push("more&nbspdispleased")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "die") {
                let meaning = randomIndexOfArray(["dead", "mortal"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
            ...
            if(intransitiveVerbArray[i] === "fail") {
                let meaning = randomIndexOfArray(["wrong", "incorrect"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "wrong") {
                                comparativeAdjectiveArray.push("more&nbspwrong")
                        };
                        if(meaning === "incorrect") {
                                comparativeAdjectiveArray.push("more&nbspincorrect")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "float") {
                let meaning = randomIndexOfArray(["light", "lofty"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "lofty") {
                                comparativeAdjectiveArray.push("loftier")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "glow"||intransitiveVerbArray[i] === "shine") {
                let meaning = "bright";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
            ...
            if(intransitiveVerbArray[i] === "go"||intransitiveVerbArray[i] === "move") {
                let meaning = randomIndexOfArray(["dynamic", "moving", "alive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "moving") {
                            comparativeAdjectiveArray.push("more&nbspmoving")
                        };
                        if(meaning === "alive") {
            ...
            if(intransitiveVerbArray[i] === "grieve") {
                let meaning = randomIndexOfArray(["grieving", "mourning"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "grieving") {
                            comparativeAdjectiveArray.push("more&nbspgrieving")
                        };
                        if(meaning === "mourning") {
                            comparativeAdjectiveArray.push("more&nbspmourning")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "lament") {
                let meaning = randomIndexOfArray(["sad", "woeful", "in&nbspdespair"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "sad") {
                            comparativeAdjectiveArray.push("sadder")
                        };
                        if(meaning === "woeful") {
                            comparativeAdjectiveArray.push("more&nbspwoeful")
                        };
                        if(meaning === "in&nbspdespair") {
                            comparativeAdjectiveArray.push("more&nbspin&nbspdespair")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "live") {
                let meaning = "alive";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
            ...
            if(intransitiveVerbArray[i] === "laugh") {
                let meaning = randomIndexOfArray(["cheerful", "hysterical"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "hysterical") {
                            comparativeAdjectiveArray.push("more&nbsphysterical")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "nod") {
                let meaning = randomIndexOfArray(["suggestive", "similar"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "suggestive") {
                            comparativeAdjectiveArray.push("more&nbspsuggestive")
                        };
                        if(meaning === "similar") {
                            comparativeAdjectiveArray.push("more&nbspsimilar")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "perish") {
                let meaning = "mortal";
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
            ...
            if(intransitiveVerbArray[i] === "pray") {
                let meaning = randomIndexOfArray(["pious", "religious", "devout"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "pious") {
                            comparativeAdjectiveArray.push("more&nbsppious")
                        };
                        if(meaning === "religious") {
                            comparativeAdjectiveArray.push("more&nbspreligious")
                        };
                        if(meaning === "devout") {
                            comparativeAdjectiveArray.push("more&nbspdevout")
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "realise") {
                let meaning = randomIndexOfArray(["alert", "aware", "suspicious"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "aware") {
                            comparativeAdjectiveArray.push("more&nbspaware");
                        };
                        if(meaning === "suspicious") {
                            comparativeAdjectiveArray.push("more&nbspsuspicious");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "reckon") {
                let meaning = randomIndexOfArray(["pensive", "accountable", "calculating"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "accountable") {
                            comparativeAdjectiveArray.push("more&nbspaccountable");
                        };
                        if(meaning === "calculating") {
                            comparativeAdjectiveArray.push("more&nbspcalculating");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "rejoice") {
                let meaning = randomIndexOfArray(["happy", "cheerful", "jolly", "blissful"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "jolly") {
                            comparativeAdjectiveArray.push("jollier");
                        };
                        if(meaning === "blissful") {
                            comparativeAdjectiveArray.push("more&nbspblissful");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "rest") {
                let meaning = "rest"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsprested");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "rot") {
                let meaning = randomIndexOfArray(["decayed", "rotten"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "decayed") {
                            comparativeAdjectiveArray.push("more&nbspdecayed");
                        };
                        if(meaning === "rotten") {
                            comparativeAdjectiveArray.push("more&nbsprotten");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "rush") {
                let meaning =  "hurried"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbsphurried");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "shit") {
                let meaning =  randomIndexOfArray(["foul", "defiling", "corrupting"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "defiling") {
                            comparativeAdjectiveArray.push("more&nbspdefiling");
                        };
                        if(meaning === "corrupting") {
                            comparativeAdjectiveArray.push("more&nbspcorrupting");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "sleep") {
                ...
                if(adjectiveArray.includes(meaning)) {
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("sleepier");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "sneak") {
                let meaning = randomIndexOfArray(["sneaky", "stealthy"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "sneaky") {
                            comparativeAdjectiveArray.push("sneakier");
                        };
                        if(meaning === "sleathy") {
                            comparativeAdjectiveArray.push("stealthier");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "stand") {
                let meaning = randomIndexOfArray(["upright", "attentive", "erect"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "upright") {
                            comparativeAdjectiveArray.push("more&nbspupright");
                        };
                        if(meaning === "attentive") {
                            comparativeAdjectiveArray.push("more&nbspattentive");
                        };
                        if(meaning === "erect") {
                            comparativeAdjectiveArray.push("more&nbsperect");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "stink") {
                let meaning = randomIndexOfArray(["smelly", "stinky", "foul", "gross", "disgusting"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "smelly") {
                            comparativeAdjectiveArray.push("smellier");
                        };
                        if(meaning === "stinky") {
                        ...
                        if(meaning === "gross") {
                            comparativeAdjectiveArray.push("grosser");
                        };
                        if(meaning === "disgusting") {
                            comparativeAdjectiveArray.push("more&nbspdisgusting");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "suffer") {
                let meaning = randomIndexOfArray(["suffering", "in&nbsppain", "tormented"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "suffering") {
                            comparativeAdjectiveArray.push("more&nbspsuffering");
                        };
                        if(meaning === "in&nbsppain") {
                            comparativeAdjectiveArray.push("more&nbspin&nbsppain");
                        };
                        if(meaning === "tormented") {
                            comparativeAdjectiveArray.push("more&nbsptormented");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "sweat") {
                let meaning = randomIndexOfArray(["sweaty", "physically&nbsptired", "exhausted"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "sweaty") {
                            comparativeAdjectiveArray.push("sweatier");
                        };
                        if(meaning === "in&nbsppain") {
                            comparativeAdjectiveArray.push("more&nbspphysically&nbsptired");
                        };
                        if(meaning === "tormented") {
                            comparativeAdjectiveArray.push("more&nbspexhausted");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "suggest") {
                let meaning = "suggestive"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
            ...
            if(intransitiveVerbArray[i] === "think") {
                let meaning = randomIndexOfArray(["thoughtful", "pensive"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "thoughtful") {
                            comparativeAdjectiveArray.push("more&nbspthoughtful");
                        };
                        if(meaning === "pensive") {
                            comparativeAdjectiveArray.push("more&nbsppensive");
                        };
            ...
            if(intransitiveVerbArray[i] === "tremble") {
                let meaning = randomIndexOfArray(["trembling", "scared", "cowardly", "afraid"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        if(meaning === "trembling") {
                            comparativeAdjectiveArray.push("more&nbsptrembling");
                        };
                        if(meaning === "scared") {
                            comparativeAdjectiveArray.push("more&nbspscared");
                        };
                        if(meaning === "cowardly") {
                            comparativeAdjectiveArray.push("more&nbspcowardly");
                        };
                        if(meaning === "afraid") {
            ...
            if(intransitiveVerbArray[i] === "understand") {
                let meaning = "understanding"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspunderstanding");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "adventure") {
                let meaning = "adventurous"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspadventurous");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "wake") {
                let meaning = "awake"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
            ...
            if(intransitiveVerbArray[i] === "weep") {
                let meaning = randomIndexOfArray(["sad", "crying", "weeping"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "crying") {
                            comparativeAdjectiveArray.push("more&nbspcrying");
                        };
                        if(meaning === "weeping") {
                            comparativeAdjectiveArray.push("more&nbspweeping");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "wish") {
                let meaning = "wishful"
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        ...
                        adjectiveArray.push(meaning);
                        comparativeAdjectiveArray.push("more&nbspwishful");
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
                        if(suffixOrPrefix === "suffix") {
            ...
            if(intransitiveVerbArray[i] === "workV") {
                let meaning = randomIndexOfArray(["industrious", "useful", "hard-working"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "hard-working") {
                            comparativeAdjectiveArray.push("more&nbsphard-working");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
            ...
            if(intransitiveVerbArray[i] === "yawn") {
                let meaning = randomIndexOfArray(["sleepy", "inattentive", "bored"])
                if(adjectiveArray.includes(meaning)) {
                        generatedAdjectives[adjectiveArray.indexOf(meaning)] = derivedTerm;
                        derivedOrInheritedADJ[adjectiveArray.indexOf(meaning)] = "derived";
                        etymologyArrayADJ[adjectiveArray.indexOf(meaning)] = intransitiveVerbArray[i];
                        ...
                        if(meaning === "inattentive") {
                            comparativeAdjectiveArray.push("more&nbspinattentive");
                        };
                        if(meaning === "bored") {
                            comparativeAdjectiveArray.push("more&nbspbored");
                        };
                        generatedAdjectives.push(derivedTerm) 
                        derivedOrInheritedADJ.push("derived");
                        etymologyArrayADJ.push(intransitiveVerbArray[i]);
    ...
    for(let i = 0; i < countNounArray.length; i++) {
        ...
        if(Math.floor(Math.random() * 3) === 1) {
            ...
            if(suffixOrPrefix === "suffix") {
                ...
                li.innerHTML = `<i>${spell(soundChange(possessorAffix))}-</i> "possessor&nbspof"`
            };
            ...
            if(countNounArray[i] === "cave") {
                ...
                if(countNounArray.includes(meaning)) {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i>&nbsp"${countNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`;
                        } else {
                                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(possessorAffix))}-</i>&nbsp"possessor&nbspof"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[countNounArray.indexOf(countNounArray[i])])))}</i>&nbsp"${countNounArray[i]}"`;
                };
                } else {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i>&nbsp"${countNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`)
                        } else {
                                etymologyCountNoun.push(`<i>${spell(soundChange(possessorAffix))}-</i>&nbsp"possessor&nbspof"&nbsp+&nbsp<i>${spell(soundChange(generatedCountNouns[countNounArray.indexOf(countNounArray[i])]))}</i>&nbsp"${countNounArray[i]}"`)
                };
                };
                if(exampleCounter < 6) {
                        let exampleLi = document.createElement("li");
                        exampleLi.innerHTML = `<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i> "${countNounArray[i]}" > <i>${spell(addGrammaticalAffixes(derivedTerm))}</i> "${meaning}"`;
                        ul.appendChild(exampleLi)
                };
                exampleCounter++; 
            };
        ...
        if(Math.floor(Math.random() * 3) === 1) {
            ...
            if(massNounArray[i] === "admiration") {
                ...
                if(countNounArray.includes(meaning)) {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i>&nbsp"${massNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`;
                        } else {
                                 etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(possessorAffix))}-</i>&nbsp"possessor&nbspof"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[massNounArray.indexOf(massNounArray[i])])))}</i>&nbsp"${massNounArray[i]}"`;
                        };
                } else {
                        countNounArray.push(meaning);
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i>&nbsp"${massNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`)
                        } else {
                ...
                if(exampleCounter < 6) {
                        let exampleLi = document.createElement("li");
                        exampleLi.innerHTML = `<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i> "${massNounArray[i]}" > <i>${spell(addGrammaticalAffixes(derivedTerm))}</i> "${meaning}"`;
                        ul.appendChild(exampleLi)
                };
                exampleCounter++; 
            };
        ...
        if(Math.floor(Math.random() * 3) === 1) {
            ...
            if(countNounArray[i] === "bag") {
                ...
                if(massNounArray.includes(meaning)) {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyMassNoun[massNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i>&nbsp"${massNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`;
                        } else {
                                 etymologyMassNoun[massNounArray.indexOf(meaning)] = `<i>${spell(soundChange(possessorAffix))}-</i>&nbsp"possessor&nbspof"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[massNounArray.indexOf(massNounArray[i])])))}</i>&nbsp"${massNounArray[i]}"`;
                        };
                } else {
                        ...
                        if(suffixOrPrefix === "suffix") {
                                etymologyMassNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i>&nbsp"${countNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(possessorAffix + "A"))}</i>&nbsp"possessor&nbspof"`)
                        } else {
...
function bodyParts() {
    ...
    for(let i = 0; i < countNounArray.length; i++) {
        ...
        if(countNounArray.includes(meaning)) {
                ...
                etymologyArrayCountNoun[countNounArray.indexOf(meaning)] = countNounArray[i];
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i>&nbsp"${countNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`;
                } else {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + bodyPartAffix))}-</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[countNounArray.indexOf(countNounArray[i])])))}</i>&nbsp"${countNounArray[i]}"`;
                };
        } else {
                countNounArray.push(meaning);
                ...
                etymologyArrayCountNoun.push(countNounArray[i]);
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedCountNouns[i])))}</i>&nbsp"${countNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`)
                } else {
    ...
    for(let i = 0; i < massNounArray.length; i++) {
        ...
        if(countNounArray.includes(meaning)) {
                ...
                etymologyArrayCountNoun[countNounArray.indexOf(meaning)] = massNounArray[i];
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i>&nbsp"${massNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`;
                } else {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + bodyPartAffix))}-</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[massNounArray.indexOf(massNounArray[i])])))}</i>&nbsp"${massNounArray[i]}"`;
                };
        } else {
                countNounArray.push(meaning);
                ...
                etymologyArrayCountNoun.push(massNounArray[i]);
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedMassNouns[i])))}</i>&nbsp"${massNounArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`)
                } else {
    ...
    for(let i = 0; i < transitiveVerbArray.length; i++) {
        ...
        if(countNounArray.includes(meaning)) {
                ...
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`;
                } else {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + bodyPartAffix))}-</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[transitiveVerbArray.indexOf(transitiveVerbArray[i])])))}-</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"`;
                };
        } else {
                countNounArray.push(meaning);
                countNounArrayPlural.push("ears");
                ...
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedTransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`)
                } else {
    ...
    for(let i = 0; i < intransitiveVerbArray.length; i++) {
        ...
        if(countNounArray.includes(meaning)) {
                ...
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`;
                } else {
                etymologyCountNoun[countNounArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + bodyPartAffix))}-</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"&nbsp+&nbsp<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[intransitiveVerbArray.indexOf(intransitiveVerbArray[i])])))}-</i>&nbsp"to&nbsp${removeVFromVerb(intransitiveVerbArray[i])}"`;
                };
        } else {
                countNounArray.push(meaning);
                ...
                if(suffixOrPrefix === "suffix") {
                etymologyCountNoun.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedIntransitiveVerbs[i])))}</i>&nbsp"to&nbsp${removeVFromVerb(transitiveVerbArray[i])}"&nbsp+&nbsp<i>-${spell(soundChange(bodyPartAffix + "A"))}</i>&nbsp"derives&nbspterms&nbspfor&nbspbody&nbspparts"`)
                } else {
        ...
        //decides if the affix will be a suffix or prefix
                ...
                if(adjectiveArray[i] === "able") {
                        ...
                        if(transitiveVerbArray.includes(meaning)) {
                                ...
                                if(suffixOrPrefix === "suffix") {
                                        etymologyTransVerb[transitiveVerbArray.indexOf(meaning)] = `<i>${spell(soundChange(addGrammaticalAffixes(generatedAdjectives[i])))}</i>&nbsp"${adjectiveArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(adjToCausativeVerbAffix + "A"))}</i>&nbsp"derives&nbspcausative&nbspverbs&nbspfrom&nbspadjectives"`;
                                } else {
                                        etymologyTransVerb[transitiveVerbArray.indexOf(meaning)] = `<i>${spell(soundChange("X" + adjToCausativeVerbAffix))}-</i>&nbsp"derives&nbspcausative&nbspverbs&nbspfrom&nbspadjectives"&nbsp+&nbsp<i>${spell(addGrammaticalAffixes(generatedAdjectives[adjectiveArray.indexOf(adjectiveArray[i])]))}</i>&nbsp"${adjectiveArray[i]}"`;
                                };
                        } else {
                                ...
                                if(suffixOrPrefix === "suffix") {
                                        etymologyTransVerb.push(`<i>${spell(soundChange(addGrammaticalAffixes(generatedAdjectives[i])))}</i>&nbsp"${adjectiveArray[i]}"&nbsp+&nbsp<i>-${spell(soundChange(adjToCausativeVerbAffix + "A"))}</i>&nbsp"derives&nbspcausative&nbspverbs&nbspfrom&nbspadjectives"`)
                                } else {
                        ...
                        if(exampleCounter < 6) {
                                let exampleLi = document.createElement("li");
                                exampleLi.innerHTML = `<i>${spell(soundChange(addGrammaticalAffixes(generatedAdjectives[i])))}</i> "${adjectiveArray[i]}" > <i>${spell(addGrammaticalAffixes(derivedTerm))}</i> "to ${meaning}"`;
                                ul.appendChild(exampleLi)
                        };
                        exampleCounter++; 
                };
