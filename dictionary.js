...
function Dictionary(word, ipa, partOfSpeech, translation, classifierExplanation, etymology, derivation) {
    this.word = word;
    this.ipa = ipa;
...
function makeDictionary() {
    let englishWords = countNounArray.concat(massNounArray, adjectiveArray, transitiveVerbArray, intransitiveVerbArray, adverbArray, conjunctionArray, adpositionArray, intensifierArray, quantifierArray);

    let languageWords = generatedCountNouns.concat(generatedMassNouns, generatedAdjectives, generatedTransitiveVerbs, generatedIntransitiveVerbs, generatedAdverbs, generatedConjunctions, generatedAdpositions, generatedIntensifiers, generatedQuantifiers);
    ...
    for (let i = 0; i < englishWords.length; i++) {
        ...
        if (countNounArray.includes(englishWords[i])) {
            ...
            wordWithAffix = languageWords[i];
            classifierInfo = "";
        } else if (quantifierArray.includes(englishWords[i])) {
            pOfSpeech = "det" + bareRoots;
            wordWithAffix = languageWords[i];
            classifierInfo = "";
        }
        if (genderNum > 0 && typologyNum === 1) {
            ...
            if (nounGenderArray.includes("animate") && nounGenderArray.includes("inanimate")) {
                if (countNounArray.includes(englishWords[i])) {
                    ...
                    if (animInan[index] === "anim") {
                        ...
                        if (genderSuffixOrPrefix === "prefix") {
                            wordWithAffix = animSgAffix + languageWords[i];
                        }
                        classifierInfo = "";;
                    } else if (animInan[index] === "inan") {
                        pOfSpeech = "n.inan" + bareRoots;
                        inanimateArray.push(generatedCountNouns[i])
                        if (genderSuffixOrPrefix === "suffix") {
                            wordWithAffix = "X" + languageWords[i] + inanSgAffix;
                        }
                        if (genderSuffixOrPrefix === "prefix") {
                            wordWithAffix = inanSgAffix + languageWords[i];
                        }
                    }
                    classifierInfo = "";;
                }
        ...
        if (genderNum > 0 && typologyNum === 2 && grammaticalNumber > 24 && grammaticalNumber < 30) {
            if (nounGenderArray.includes("animate") && nounGenderArray.includes("inanimate")) {
                if (countNounArray.includes(englishWords[i])) {
                    let index = countNounArray.indexOf(englishWords[i])
                    if (animInan[index] === "anim") {
        ...
        if (typologyNum === 2 && grammaticalNumber < 24 && caseNumber === 0 && genderNum < 9 && markedSingularOrNot() === true) {
            if (countNounArray.includes(englishWords[i])) {
                if (markedSingularOrNot() && numberSuffixOrPrefix === "suffix") {
                    wordWithAffix = wordWithAffix + singularAffix;
                }
        ...
        let derivations = document.createElement("span");
        ...
        if(adjectiveArray.includes(englishWords[i])) {
            if(derivedOrInheritedADJ[adjectiveArray.indexOf(englishWords[i])] === "inherited") {
                ...
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListAdj[adjectiveArray.indexOf(englishWords[i])]}`;
            ...
            if(derivedOrInheritedMassNoun[massNounArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListMassNoun[massNounArray.indexOf(englishWords[i])]}`;
            ...
            if(derivedOrInheritedTransVerb[transitiveVerbArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListTransVerb[transitiveVerbArray.indexOf(englishWords[i])]}`
            ...
            if(derivedOrInheritedIntransVerb[intransitiveVerbArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListIntransVerb[intransitiveVerbArray.indexOf(englishWords[i])]}`
            } else if (derivedOrInheritedIntransVerb[intransitiveVerbArray.indexOf(englishWords[i])] === "derived"||derivedOrInheritedIntransVerb[transitiveVerbArray.indexOf(englishWords[i])] === "inheritedOldDerived") {
                    etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbsp${etymologyIntransVerb[intransitiveVerbArray.indexOf(englishWords[i])]}`;
                    derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListIntransVerb[intransitiveVerbArray.indexOf(englishWords[i])]}`;
                };
        }  else if(adpositionArray.includes(englishWords[i])) {
            if(derivedOrInheritedADPO[adpositionArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListAdpo[adpositionArray.indexOf(englishWords[i])]}`
            } else if (derivedOrInheritedADPO[adpositionArray.indexOf(englishWords[i])] === "derived"||derivedOrInheritedADPO[adpositionArray.indexOf(englishWords[i])] === "inheritedOldDerived") {
                    etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbsp${etymologyADPO[adpositionArray.indexOf(englishWords[i])]}`;
                    derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListAdpo[adpositionArray.indexOf(englishWords[i])]}`;
                };
        }  else if(quantifierArray.includes(englishWords[i])) {
            if(derivedOrInheritedQuantifier[quantifierArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListQuantfier[quantifierArray.indexOf(englishWords[i])]}`
            } else if (derivedOrInheritedQuantifier[quantifierArray.indexOf(englishWords[i])] === "derived"||derivedOrInheritedQuantifier[quantifierArray.indexOf(englishWords[i])] === "inheritedOldDerived") {
                    etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbsp${etymologyQuantifier[quantifierArray.indexOf(englishWords[i])]}`;
                    derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListQuantfier[quantifierArray.indexOf(englishWords[i])]}`;
                };
        }  else if(intensifierArray.includes(englishWords[i])) {
            if(derivedOrInheritedINTENS[intensifierArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListIntensifier[intensifierArray.indexOf(englishWords[i])]}`
            } else if (derivedOrInheritedINTENS[intensifierArray.indexOf(englishWords[i])] === "derived"||derivedOrInheritedINTENS[intensifierArray.indexOf(englishWords[i])] === "inheritedOldDerived") {
                    etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbsp${etymologyQuantifier[intensifierArray.indexOf(englishWords[i])]}`;
                    derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListIntensifier[intensifierArray.indexOf(englishWords[i])]}`;
                };
        }  else if(adverbArray.includes(englishWords[i])) {
            if(derivedOrInheritedADV[adverbArray.indexOf(englishWords[i])] === "inherited") {
                etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
                derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListAdverb[adverbArray.indexOf(englishWords[i])]}`
            } else if (derivedOrInheritedADV[adverbArray.indexOf(englishWords[i])] === "derived"||derivedOrInheritedADV[adverbArray.indexOf(englishWords[i])] === "inheritedOldDerived") {
                    etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbsp${etymologyQuantifier[adverbArray.indexOf(englishWords[i])]}`;
                    derivations.innerHTML = `&nbsp&nbsp&nbsp&nbsp${derivationListAdverb[adverbArray.indexOf(englishWords[i])]}`;
                };
        } else {
            etymology.innerHTML = `<br>&nbsp&nbsp&nbsp&nbsp<&nbspOld&nbsp${capitaliseLanguageName(languageName)}&nbsp<i>${word1.etymology}</i>&nbsp"${etymologyTranslation}"`;
        ...
        entry.innerHTML = `${headWord.innerHTML} ${ipaTranscription.innerHTML} ${pOS.innerHTML} ${meaning.innerHTML} ${classiferEtymology.innerHTML} ${etymology.innerHTML} ${derivations.innerHTML}`;
        document.getElementById("language-to-english").appendChild(entry);
        let hrLine = document.createElement("hr");
        hrLine.classList.add("dictionaryHr")
        document.getElementById("language-to-english").appendChild(hrLine);
    };
    ...
    for (let i = 0; i < entryDiv.length; i++) {
        ...
        entryDiv[i].appendChild(derivation)
    }
