let massNounArray = [];
let singulativeMassNounArray = [];
let pluralSingulativeMassNounArray = [];
let activePassiveMass = [];
let animInanMass = [];
let divineNonDivineMass = [];
let humanAnimalInanMass = [];
let mascFemMass = [];
let mascFemNeutMass = [];
let naturalArtificialMass = [];
...
function addWords() {
    ...
    mascFemNeutMass.push("neuter");
    mascFemMass.push("masculine1");
    naturalArtificialMass.push("artificial");
    ...
    singulativeMassNounArray.push("clump&nbspof&nbspclayy");
